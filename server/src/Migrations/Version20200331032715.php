 ...
 */
final class Version20200331032715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game_users (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, player1_id INT DEFAULT NULL, player2_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_26B0DC66E48FD905 (game_id), INDEX IDX_26B0DC66C0990423 (player1_id), INDEX IDX_26B0DC66D22CABCD (player2_id), INDEX IDX_26B0DC665DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, status_id INT NOT NULL, INDEX IDX_232B318C6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game_status (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_moves (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, user_id INT NOT NULL, state VARCHAR(64) NOT NULL, timestamp DATETIME NOT NULL, INDEX IDX_770C71BDE48FD905 (game_id), INDEX IDX_770C71BDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_status (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(30) NOT NULL, timestamp timestamp default CURRENT_TIMESTAMP, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C6BF700BD FOREIGN KEY (status_id) REFERENCES game_status (id)');
        ...
        $this->addSql('ALTER TABLE game_moves ADD CONSTRAINT FK_770C71BDA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_moves DROP FOREIGN KEY FK_770C71BDA76ED395');
